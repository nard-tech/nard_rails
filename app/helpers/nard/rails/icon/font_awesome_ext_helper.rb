# @see FontAwesome::Rails::IconHelper を拡張
# @note https://github.com/bokmann/font-awesome-rails/blob/master/app/helpers/font_awesome/rails/icon_helper.rb
module Nard::Rails::Icon::FontAwesomeExtHelper
  ...
  def fa_icon_nd(names = "flag", options = {})
    classes = ["fa"]
  ...
  #   # => </span>
  def fa_stacked_icon_nd(names = "flag", options = {})
